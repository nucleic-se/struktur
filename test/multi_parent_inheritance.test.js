...
describe('Multi-Parent Inheritance', () => {
  ...
  beforeEach(async () => {
    ...
    await classLoader.loadClass(path.join(fixturesDir, 'mixin_a.class.json'));
    await classLoader.loadClass(path.join(fixturesDir, 'mixin_b.class.json'));
    await classLoader.loadClass(path.join(fixturesDir, 'multi_parent.class.json'));
  });
